...
public:
  ...
  SC_PROPERTY(Keynode("question_find_diameter"), ForceCreate)
  static ScAddr question_find_diameter;

  SC_PROPERTY(Keynode("nrel_diameter_node"), ForceCreate)
  static ScAddr nrel_diameter_node;
  
  SC_PROPERTY(Keynode("diameter"), ForceCreate)
  static ScAddr diameter;
